...
// ── Triangle-mesh variant (geometry index RtInOneWeekend = 3) ─────────────────
...
// ── Procedural sphere variant (geometry index RtInOneWeekendProc = 4) ─────────
// Each sphere is a single PROCEDURAL_LEAF primitive. Sphere geometry lives in
// shape_buf_ (indexed by primitiveID), keeping tri_buf_ only for BVH bounds.

namespace RtInOneWeekendProc {
